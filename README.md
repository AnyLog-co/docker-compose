...
Key values to set in the *[*basic config](docker-makefiles/operator1-configs/base_configs.env)**:
...
[Advanced configurations](docker-makefiles/operator1-configs/advance_configs.env) covers optional settings like thread usage, geolocation overrides, and Nebula overlay support.
...
```shell
cp docker-makefiles/operator1-configs docker-makefiles/operator2-configs
```
...
**[Basic Configs](docker-makefiles/operator1-configs/base_configs.env)**
...
**[Advanced Configs](docker-makefiles/operator1-configs/advance_configs.env)**
