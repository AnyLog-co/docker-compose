    ...
    for section in node_configs:
        ...
        if status is True:
            ...
            if section == 'networking':
                ...
                node_configs[section] = questionnaire.blockchain_configs(configs=node_configs[section])
            elif section == 'operator' and args.node_type in ["operator", "generic"]:
                node_configs[section] = questionnaire.operator_configs(configs=node_configs[section])
